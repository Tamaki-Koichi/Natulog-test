...
var MESSAGE_TEMPLATE =
    ...
    '<img id="icons" class="posted-img" src="./images/麻雀女子 3.png" alt="">' +
    ...
    function showmessage(id, timestamp, name, uid) {
        // 新しいDOMオブジェクトを生成
...
function displayMessage(id, timestamp, name, text, picUrl, imageUrl, uid) {
    ...
    var div =
        document.getElementById(id) || showmessage(id, timestamp, name, uid);
